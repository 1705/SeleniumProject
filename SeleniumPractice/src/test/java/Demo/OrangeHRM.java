...
public class OrangeHRM {
	...
	public void addEmployee() throws InterruptedException, IOException 
	{
		...
		//find last name
		driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("Chaudhari");
		...
		Runtime.getRuntime().exec("C://Users//nikhi//OneDrive//Desktop//Project-OrangeHRM//SeleniumPractice//AddImageOrangeHRM.exe");
	...
	public void searchEmployeeByName() throws IOException, InterruptedException
	{
		logIn();
		//find PIM menu and click on PIM menu
		driver.findElement(By.xpath("//span[text()='PIM']")).click();
		...
		driver.findElements(By.tagName("input")).get(1).sendKeys("Vaishali");
	...
	public void searchEmployeeById() throws IOException, InterruptedException
	{
		String empId = "0290";
	...
	public void fileUpload() throws IOException, InterruptedException
	{
		...
		Runtime.getRuntime().exec("C://Users//nikhi//OneDrive//Desktop//Project-OrangeHRM//SeleniumPractice//UploadFileAutoItScript.exe");
	...
	public void deleteEmplyoyee() throws IOException, InterruptedException
	{
		logIn(); 
		//find PIM menu and click on PIM menu
		driver.findElement(By.xpath("//span[text()='PIM']")).click();
		...
		driver.findElements(By.tagName("input")).get(1).sendKeys("Silme");
	...
	public void ListEmployees() throws IOException, InterruptedException
	{
		logIn();
